        ...
        <div class="StaticLoggedOutHomePage-content">
            ...
            <div class="StaticLoggedOutHomePage-cell StaticLoggedOutHomePage-utilityBlock" style="max-width:612px;" >
                ...
                <div class="StaticLoggedOutHomePage-signupBlock">
                    ...
                    <img src="https://upload.wikimedia.org/wikipedia/fr/c/c8/Twitter_Bird.svg" height="100" width="100"/>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-bottom">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li class="StreamsFooter-item"><a href="marketing" rel="noopener">Businesses</a></li>
                    <li class="StreamsFooter-item"><a href="marketing" rel="noopener">Developers</a></li>
                    <li class="StreamsFooter-item"><a href="marketing" rel="noopener">Directory</a></li>
